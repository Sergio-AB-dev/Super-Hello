...
const Benefits = () => {
    return (
        ...
        <div className="benefits_card-container">
            ...
            <Benefits_card Imgsrc={card1} title="Unlimited Do-Overs & Wishlists" text="At a single monthly rate, you get to call the shots with unlimited design requests and revisions. Keep tweaking until your design hits the sweet spot. You dream it, we design it!"/>
            <Benefits_card Imgsrc={card1} title="Unlimited Do-Overs & Wishlists" text="At a single monthly rate, you get to call the shots with unlimited design requests and revisions. Keep tweaking until your design hits the sweet spot. You dream it, we design it!"/>
        </div>
